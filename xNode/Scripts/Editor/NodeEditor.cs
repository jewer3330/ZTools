...
namespace XNodeEditor {
    ...
    [CustomNodeEditor(typeof(ZTool.XNode.Node))]
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, ZTool.XNode.Node> {
        ...
        public virtual void OnBodyGUI() {
            ...
            foreach (ZTool.XNode.NodePort dynamicPort in target.DynamicPorts) {
        ...
        XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, ZTool.XNode.Node>.INodeEditorAttrib {
