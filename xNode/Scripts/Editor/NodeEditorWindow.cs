...
namespace XNodeEditor {
    ...
    public partial class NodeEditorWindow : EditorWindow {
        ...
        public Dictionary<ZTool.XNode.NodePort, Rect> portConnectionPoints { get { return _portConnectionPoints; } }
        private Dictionary<ZTool.XNode.NodePort, Rect> _portConnectionPoints = new Dictionary<ZTool.XNode.NodePort, Rect>();
        ...
        [System.Serializable] private class NodePortReference {
            [SerializeField] private ZTool.XNode.Node _node;
            [SerializeField] private string _name;

            public NodePortReference(ZTool.XNode.NodePort nodePort) {
                _node = nodePort.node;
                _name = nodePort.fieldName;
            }

            public ZTool.XNode.NodePort GetNodePort() {
                if (_node == null) {
                    return null;
                }
        ...
        private void OnEnable() {
            ...
            if (length == _rects.Length) {
                for (int i = 0; i < length; i++) {
                    ZTool.XNode.NodePort nodePort = _references[i].GetNodePort();
                    if (nodePort != null)
        ...
        public Dictionary<ZTool.XNode.Node, Vector2> nodeSizes { get { return _nodeSizes; } }
        private Dictionary<ZTool.XNode.Node, Vector2> _nodeSizes = new Dictionary<ZTool.XNode.Node, Vector2>();
        public ZTool.XNode.NodeGraph graph;
        ...
        private static void OnSelectionChanged() {
            ZTool.XNode.NodeGraph nodeGraph = Selection.activeObject as ZTool.XNode.NodeGraph;
        ...
        public void SaveAs() {
            ...
            if (string.IsNullOrEmpty(path)) return;
                ...
                ZTool.XNode.NodeGraph existingGraph = AssetDatabase.LoadAssetAtPath<ZTool.XNode.NodeGraph>(path);
        ...
        public void SelectNode(ZTool.XNode.Node node, bool add) {
            if (add) {
        ...
        public void DeselectNode(ZTool.XNode.Node node) {
            List<Object> selection = new List<Object>(Selection.objects);
        ...
        public static bool OnOpen(int instanceID, int line) {
            ZTool.XNode.NodeGraph nodeGraph = EditorUtility.InstanceIDToObject(instanceID) as ZTool.XNode.NodeGraph;
            if (nodeGraph != null) {
                Open(nodeGraph);
                return true;
            }
        ...
        public static NodeEditorWindow Open(ZTool.XNode.NodeGraph graph) {
