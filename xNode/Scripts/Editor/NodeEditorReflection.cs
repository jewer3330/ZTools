...
namespace XNodeEditor {
    ...
    public static class NodeEditorReflection {
        ...
        public static Type[] GetNodeTypes() {
            ...
            return GetDerivedTypes(typeof(ZTool.XNode.Node));
        }
        ...
        public static bool TryGetAttributeTint(this Type nodeType, out Color tint) {
            if (nodeTint == null) {
                CacheAttributes<Color, ZTool.XNode.Node.NodeTintAttribute>(ref nodeTint, x => x.color);
            }
        ...
        public static bool TryGetAttributeWidth(this Type nodeType, out int width) {
            if (nodeWidth == null) {
                CacheAttributes<int, ZTool.XNode.Node.NodeWidthAttribute>(ref nodeWidth, x => x.width);
            }
        ...
        public static FieldInfo GetFieldInfo(this Type type, string fieldName) {
            ...
            while (field == null && (type = type.BaseType) != typeof(ZTool.XNode.Node)) field = type.GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
            return field;
        }
