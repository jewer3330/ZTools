...
namespace XNodeEditor {
    ...
    [CustomEditor(typeof(ZTool.XNode.NodeGraph), true)]
#if ODIN_INSPECTOR
    ...
    public class GlobalGraphEditor : Editor {
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button("Edit graph", GUILayout.Height(40))) {
                NodeEditorWindow.Open(serializedObject.targetObject as ZTool.XNode.NodeGraph);
            }
    ...
    [CustomEditor(typeof(ZTool.XNode.Node), true)]
#if ODIN_INSPECTOR
    ...
    public class GlobalNodeEditor : Editor {
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button("Edit graph", GUILayout.Height(40))) {
                SerializedProperty graphProp = serializedObject.FindProperty("graph");
                NodeEditorWindow w = NodeEditorWindow.Open(graphProp.objectReferenceValue as ZTool.XNode.NodeGraph);
                w.Home(); // Focus selected node
            }
